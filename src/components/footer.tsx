          ...
          <div className="space-y-3.5">
            ...
            <div className="flex gap-2">
              {[
                ...
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-[12px] border-2 border-ink/20 flex items-center justify-center hover:bg-brick hover:text-ink hover:border-ink transition-all" aria-label={s.label}>
