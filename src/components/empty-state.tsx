...
export function EmptyState({ icon, title, description, action, className }: EmptyStateProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="flex h-20 w-20 items-center justify-center rounded-[1.5rem] border-2 border-ink bg-gradient-to-br from-white to-surface-alt shadow-[6px_6px_0px_0px_rgba(26,26,26,1)] dark:from-zinc-900 dark:to-zinc-800"
